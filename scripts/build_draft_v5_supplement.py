...
def parameter_source_table(config: dict[str, Any], commit: str) -> pd.DataFrame:
    rows = [
        ...
        ("Menstrual", "Hormone trajectories", "hormone_cycler daily reference envelope and long-follicular E2 variants", "Both", "LH-aligned daily Stricker medians mapped to ovulation with PCHIP; terminal follicular maturation is not stretched in long cycles; deterministic delayed-emergence or failed-wave E2 geometry", "Cycle/day", "Stricker et al. 2006; Harlow et al. 2000; Mumford et al. 2012", "No", "Independent Anckaert subphase amplitudes plus prespecified daily morphology checks", commit),
