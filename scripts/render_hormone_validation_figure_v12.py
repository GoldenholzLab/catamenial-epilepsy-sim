#!/usr/bin/env python3
"""Render the v12 healthy-cycle calibration and external-validation figure."""
...
def main() -> int:
    ...
    parser.add_argument("--validation", type=Path, default=ROOT / "examples" / "reports" / "healthy_cycle_validation_v12.json")
    parser.add_argument("--output", type=Path, default=ROOT / "examples" / "reports" / "hormone_cycle_validation_v12.png")
